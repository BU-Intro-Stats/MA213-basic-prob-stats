...
-   Learn to create a variety of plots to explore and present numerical and categorical data.
-   Gain a foundational understanding of data manipulation using base R commands and the `dplyr` package.
-   Explore the core features of the `ggplot2` package for data visualization, along with base R plotting functions.

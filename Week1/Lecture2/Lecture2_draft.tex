...
\begin{frame}
	...
	\begin{itemize}
		\item \textbf{Step 1: Think (1 minute):} Think to yourself about how you would answer the question. You can briefly write down your thoughts for the next steps.
		\item \textbf{Step 2: Pair (5 minutes):} Get into pairs, get to know each other, and discuss the question together. 
		\item \textbf{Step 3: Share (2 minutes):} Share your and your partner's thoughts on the forum, and read others' responses.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	Which sampling technique do you think has more chance of yielding a sample that is representative of the whole population? Why?
\end{frame}

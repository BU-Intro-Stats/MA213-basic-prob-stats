...
\begin{frame}
	\frametitle{People}
	\begin{itemize}
		\item \hl{Instructor:} Dr. Yongho Lim
		\item \hl{Labs:} Prof. Emily Stephen
		\item \hl{Graduate Teaching Fellows (TFs):} 
		\begin{itemize}
			\item Lucia Vilalonga (Discussions)
			\item Noah Kupinsky (Discussions)
			\item Sydney Elliot (Labs)
		\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Please bring a pen or pencil for worksheets
			\item Will be recorded
		\end{itemize}
		\item \hl{Labs}: Fridays
		\begin{itemize}
			\item Check your schedule for your time and location
			\item Please bring a laptop or tablet for in-lab activities
			\item Please bring a pen or pencil for worksheets
...
\begin{frame}
	\frametitle{Labs} 
	Led by Emily Stephen, with support from TFs and LAs
	\begin{itemize}
		\item \hl{Weekly labs} on Fridays, starting this week
		\begin{itemize}
			\item Bring a laptop
			\item Bring a pen or pencil for worksheets
		\end{itemize}
		\item \hl{Skills labs}
		\begin{itemize}
			\item Work in pairs
		...
		\end{itemize}
	\end{itemize}
	You will receive an email with instructions for setting up your computer for R, RStudio and Lab Tutorial. Please complete the setup before your first lab!
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \hl{Homework 1} due Tuesday, Sep 8 at 3:00pm
		\end{itemize} 
		\item 5 \hl{Quizzes} 
		\begin{itemize} % TODO update
			\item In Lecture time, see calendar in Syllabus
			\item 18 Core Learning Objectives, 11 Auxiliary Learning Objectives
			\item 5-6 written problems, graded pass / almost pass / not yet
			\item Can \textbf{qualify} to retake missed problems at the end of the semester (details later)
		\end{itemize}
...
\begin{frame}
	\frametitle{Learning Objectives} % TODO check these
	...
	\begin{enumerate}
		...
		\item (\textcolor{red}{core}, Q1, Labs) Use R for Data Management and Exploration
...
\begin{frame} % TODO check these
	\frametitle{Learning Objectives}
	Module 6: Global module (\textcolor{red}{core})
	\begin{enumerate}
		\item (\textcolor{red}{core}, Projects) I can carry out a complete, reproducible statistical workflow in R using the inference methods from the course  
		\item (\textcolor{red}{core}, Quizzes) Given R code for a statistical analysis, I can explain what it does and why, and identify both programmatic and statistical errors 
		\item (\textcolor{red}{core}, Quizzes) When solving probability and statistics problems, I can support my answers by writing out the steps using the notation and conventions of statistical exposition  
		\item (\textcolor{red}{core}, Projects) I can recognize whether a statistical workflow is appropriate for the given data and data analysis goals, and explain the results of a statistical analysis to stakeholders
	\end{enumerate}
\end{frame}
...
\end{frame}
\begin{frame}
	\frametitle{Class Policies: Use of Generative AI Tools (e.g. ChatGPT)} 
	\begin{itemize}
		\item \hl{Motivation:}
		\begin{itemize}
			\item The same way calculus is a system for describing change, statistics is a system for describing uncertainty.
			\item Learning statistics is about developing your own statistical reasoning and coding skills.
			\item GenAI tools can either help you learn or can be used to bypass the learning process.
		\end{itemize}
		\item \hl{Policies:}
		\begin{itemize}
			\item Quizzes: \textbf{Not allowed}.
			\item Homeworks: Use at your own discretion
			\item Skills Labs: Not allowed
			\item Lab Projects: Allowed for \textbf{specific uses} with \textbf{proper documentation}.
			\item See GenAI policy on the course website for details.
		\end{itemize}
	\end{itemize}
\end{frame}
...
% Calendar
\begin{frame}
	\frametitle{Course Calendar} % TODO update
    \begin{center}
        \includegraphics[width=0.95\textwidth]{figures/2026_Calendar.png}
    \end{center}
	\begin{itemize}
		...
		\item \hl{Skills Lab Tutorials:} Due before the following Lab
...
\begin{frame}
	\frametitle{Worksheet: Case Study}
	Complete the worksheet for this case study. You will work on it individually, then with a partner, and finally share your thoughts with the class.
	\begin{itemize}
		...
		\item \textbf{Share (3 mins):} Share your thoughts with the class.
	\end{itemize}
\end{frame}
...
\include{Lecture1_announcements}

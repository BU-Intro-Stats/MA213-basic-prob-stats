...
\begin{tabular}{|p{0.10\textwidth}|p{0.10\textwidth}|p{0.06\textwidth}|p{0.23\textwidth}|p{0.07\textwidth}|p{0.14\textwidth}|p{0.08\textwidth}|p{0.08\textwidth}|}
\hline
...
\hline
\parbox[t]{0.09\textwidth}{\centering 1 (9/2)} & 1; 2.1 & 1 & Course introduction; Introduction to data & Lab 1 &  &  &  \\
\hline
\parbox[t]{0.09\textwidth}{\centering 2 (9/7)} & 2.2; 2.3 & 1 & Examining numerical data; Considering categorical data & Lab 2 & Lab2 in-lab activity submission; Tutorial 2 & 1 &  \\
\hline
\parbox[t]{0.09\textwidth}{\centering 3 (9/14)} & 3.1; 3.2–3.3; 3.4 & 1; 2 & Two case studies; Probability; Conditional Probability, Sampling & Lab 3 & Lab3 in-lab activity submission; Tutorial 3 & 2 &  \\
\hline
\parbox[t]{0.09\textwidth}{\centering 4 (9/21)} & 3.5; 4.1 & 2 & Sampling from a small population, Random Variables; Continuous Distributions & Project1-1 & Project1-1: Project 1 plan & 3 & Quiz 1 \\
\hline
\parbox[t]{0.09\textwidth}{\centering 5 (9/28)} & 4.2; 4.3 & 2 & Continuous Distributions, Normal distribution; Normal distribution, continued; Geometric distribution & Lab 4 & Project 1 Outline; Lab4 in-lab activity submission; Tutorial 4 & 4 &  \\
\hline
\parbox[t]{0.09\textwidth}{\centering 6 (10/5)} & 4.5; 5.1 & 2; 3 & Binomial distribution; Poisson distribution; Point estimates and sampling variability & Lab 5 & Lab5 in-lab activity submission; Tutorial 5 & 5 &  \\
\hline
\parbox[t]{0.09\textwidth}{\centering 7 (10/12)\\\scriptsize Tues is\\Mon schedule} & 5.2; 5.3 & 3 & Point estimates and sampling variability, continued; Confidence intervals & Project1-2 &  & 6 & Quiz 2 \\
\hline
\parbox[t]{0.09\textwidth}{\centering 8 (10/19)} & 6.1; 6.2 & 3 & Hypothesis testing for a proportion; Hypothesis testing for a proportion, continued; Inference for a single proportion & Project2-1 & Project2-1: Project1 Video & 7 &  \\
\hline
\end{tabular}
\end{center}
\newpage
...
\textbf{Week} & \textbf{Reading (Chapter)} & \textbf{Module} & \textbf{Lecture Topics} & \textbf{Labs} & \begin{tabular}[t]{@{}c@{}}\textbf{Lab}\\\textbf{Deliverable}\end{tabular} & \textbf{Homework due Mon} & \textbf{Quiz} \\
\hline
\parbox[t]{0.09\textwidth}{\centering 9 (10/26)} & 6.3; 6.4; 7.1 & 4 & Difference of two proportions; Testing for goodness of fit using chi-square; Testing for independence in two-way tables & Lab 6 & Lab6 in-lab activity submission; Tutorial 6; Project2 Outline & 8 &  \\
\hline
\parbox[t]{0.09\textwidth}{\centering 10 (11/2)} & 7.2; 7.3 & 4 & One-sample means with the t-distribution; CIs for one-sample means, Paired data & Project2-2 &  & 9 & Quiz 3 \\
\hline
\parbox[t]{0.09\textwidth}{\centering 11 (11/9)} & 7.4; 7.5 & 4 & Difference of two means; Power calculations for a difference of means; Issues with Hypothesis Testing 1: The traps of insufficient power & Project2-3 & Project2-3: Project2 Progress Report & 10 &  \\
\hline
\parbox[t]{0.09\textwidth}{\centering 12 (11/16)} & 1 & 4; 5 & Comparing many means with ANOVA; Issues with Hypothesis Testing 2: Multiple comparisons; Beyond Recipes: Frequentist and Bayesian Approaches to Statistical Modeling & Lab 7 & Project2 writeup; Lab7 in-lab activity submission; Tutorial 7 & 11 &  \\
\hline
\parbox[t]{0.09\textwidth}{\centering 13 (11/23)\\\scriptsize No classes\\Wed-Fri} &  &  &  & Lab 8 & Project2 Resubmission &  & Quiz 4 \\
\hline
\parbox[t]{0.09\textwidth}{\centering 14 (11/30)} & 2; 3 & 5 & Frequentist modeling using the likelihood function; Bayesian modeling with discrete distributions; Bayesian modeling with the beta-binomial model &  &  & 12 &  \\
\hline
\parbox[t]{0.09\textwidth}{\centering 15 (12/7)} &  & 5 & Case study in modern statistical modeling; Wrap-up and evaluations &  &  &  & Quiz 5 \\
\hline
\end{tabular}
\end{center}

...
\begin{itemize}
  ...
  \item What are (at least) two possible explanations for Buzz pushing the correct button most of the time?
\end{itemize}
...
\begin{itemize}
  ...
  \item What are (at least) two possible explanations for Buzz's performance?

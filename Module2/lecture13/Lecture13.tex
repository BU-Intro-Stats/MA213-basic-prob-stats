...
\include{Lecture13_announcements}
...
\hl{Geometric distribution} describes the number of trials until a success for \hl{iid} Bernoulli random variables.
...
\only<1>{
\begin{center}
\includegraphics[width=0.8\textwidth]{\chpiv@path/4-3_binomial_distribution/figures/homeschool}
\end{center}
}

...
read.csv("data/mtcars.csv", stringsAsFactors = FALSE) #— base R CSV reader (common).
read.table("data/mtcars.csv", header = TRUE, sep = "\t") #— base R for general delimited files.
readr::read_csv("data/mtcars.csv") #— fast tidyverse CSV reader (recommended for speed and consistent parsing).
```

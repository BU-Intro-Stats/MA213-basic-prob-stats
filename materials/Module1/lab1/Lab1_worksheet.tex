...
\textbf{Big idea:} This first lab is about getting set up and learning how lab works. There is no statistics to learn today. Your goal is to leave with R running, Tutorial 1 submitted, and this worksheet handed in.
...
\section*{Part 4. Tutorial 1 and Your Hash Code}

Work through \textbf{Tutorial 1}. At the end it will generate a \textbf{hash code}.
...
\textbf{Question} & \textbf{Your answer} \\
\hline
Did you complete Tutorial 1? (yes / no) & \\
\hline
...
Tutorial 1 hash submitted to Blackboard: \shortblank\\[.6em]

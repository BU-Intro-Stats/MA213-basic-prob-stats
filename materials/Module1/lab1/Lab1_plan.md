...
- 15 min Tutorial 1: complete in lab, submit hash code to Blackboard
...
The last three run concurrently, not in sequence. Students who already have R start Tutorial 1 right away, which frees you for the install problems.
...
- After lab: check Blackboard hash submissions against the roster, email anyone missing. Tutorial 2 is due **before** Lab 2.

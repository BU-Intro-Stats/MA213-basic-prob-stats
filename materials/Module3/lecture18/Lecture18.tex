...
\include{Lecture18_agenda}
\include{Lecture18_announcements}
...
\section{Worksheet: Significance levels}

\begin{frame}
\frametitle{Worksheet: Significance levels}

Pick up the worksheet and find a partner.

\begin{itemize}
    \item \textbf{Step 1 (Think, 2 min):} connect confidence level to significance level, and evaluate statements comparing $\alpha=0.05$ to $\alpha=0.01$.
    \item \textbf{Step 2 (Pair, 2 min):} compare answers with your partner and discuss the Type 1/Type 2 error tradeoff.
\end{itemize}

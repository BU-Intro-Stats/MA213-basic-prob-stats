...
<!--
Instructor notes:
- Syllabus: this file controls descriptions and policies for each assessment category.
- Dates, times, titles, and counts should come from the existing homework, quiz, lecture, lab, and exception inputs whenever possible.

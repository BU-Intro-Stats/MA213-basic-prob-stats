...
2.  You are going to make an function named `my_sim(n)` which takes input of `n` and gives an output list of `mu_simulated` and `sigma_2_``simulated` (hint: sample with custom probabilities can be added by `sample(x, size, prob=c(0.40, 0.60))` ).

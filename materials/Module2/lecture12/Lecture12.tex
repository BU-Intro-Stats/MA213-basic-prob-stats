...
\include{Lecture12_announcements}
...
\twocol{0.4}{0.6}{
    \begin{center}
        \includegraphics[width=0.35\paperwidth]{\weekv@path/figures/Bernoulli_PMF.png}
        \includegraphics[width=0.35\paperwidth]{\weekv@path/figures/Bernoulli_CDF.png}
    \end{center}
}{
    % Bernoulli Distribution PMF Table
    \begin{small}
...
\hl{Geometric distribution} describes the number of trials until a success for \hl{independent and identically distributed (iid)} Bernoulli random variables.
\begin{itemize}
...
\twocol{0.4}{0.6}{
    \begin{center}
        \includegraphics[width=0.35\paperwidth]{\weekv@path/figures/Geometric_PMF.png}
        \includegraphics[width=0.35\paperwidth]{\weekv@path/figures/Geometric_CDF.png}
    \end{center}
}{
...
\section{Worksheet: Using the Geometric distribution}

\begin{frame}
\frametitle{Worksheet: Using the Geometric distribution}

Pick up the worksheet and find a partner.

\begin{itemize}
    \item \textbf{Step 1 (Think, 2 min):} set up and compute a Geometric probability for a new scenario.
    \item \textbf{Step 2 (Pair, 2 min):} apply the same idea back to the Milgram experiment, and discuss the modeling assumptions.
\end{itemize}

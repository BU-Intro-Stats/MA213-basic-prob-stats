...
<!--
Instructor notes:
- Calendar: Lecture rows set lecture/quiz event times. Discussion and Office Hour rows create repeating calendar events.
- Weekly schedule: this file controls lecture dates, but it does not add text to the weekly schedule columns.
- Homework is controlled separately in Homework_schedule.md.
-->

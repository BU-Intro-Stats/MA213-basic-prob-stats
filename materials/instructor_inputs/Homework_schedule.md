...
<!--
Instructor notes:
- Calendar: each row creates one homework due event. Homework uses only End Time, displayed as "Due ...".
- Weekly schedule: homework is not shown in the weekly schedule table.
- To skip a week, delete or omit that homework row.
-->

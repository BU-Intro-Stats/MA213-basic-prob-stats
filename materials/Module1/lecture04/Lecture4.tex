...
\input{Lecture4_announcements.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Examining numerical data (cont'd)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{R Demo: Box plots and Outliers}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tikzpicture}
  ...
  \node[anchor=east, text=red, font=\bfseries\small, visible on=<2>] at (-0.4,3.2) {Q3};
 \pause
...
% \begin{enumerate}
%   \item  \webURL{https://www.isi-stats.com/isi2nd/ISIapplets2021.html}

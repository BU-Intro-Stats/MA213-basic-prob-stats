...
In this lab session, we will go over random variables and compute the expectation and variance of random variables and their linear combinations. We will verify whether the expected properties holds using R.
...
-   Conduct simulation study for evaluation purposes

...
\input{Lecture3_announcements.tex}
...
\begin{frame}
	...
	\begin{center}
	\includegraphics[width=0.9\textwidth]{\chpi@path/1-3_sampling_principles_strategies/figures/sampling_methods/simple}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
	\includegraphics[width=0.9\textwidth]{\chpi@path/1-3_sampling_principles_strategies/figures/sampling_methods/stratified}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
	\includegraphics[width=0.9\textwidth]{\chpi@path/1-3_sampling_principles_strategies/figures/sampling_methods/cluster}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
	\includegraphics[width=0.9\textwidth]{\chpi@path/1-3_sampling_principles_strategies/figures/sampling_methods/multistage}
	\end{center}
...
\begin{frame}
	\frametitle{Worksheet: sampling/bias}

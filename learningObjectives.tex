...
\begin{enumerate}
    ...
    \item \textbf{Inference for a Single Proportion:} Design, execute, and interpret confidence intervals and hypothesis tests for a single proportion. [Q3, L4] \textcolor{red}{Core}
    ...
    \item \textbf{Calculate Sample Size for Confidence Intervals:} Calculate the required minimum sample size for a given margin of error and confidence level. [Q3, L5] \textcolor{blue}{Auxiliary}
\end{enumerate}
...
\begin{enumerate}
    \item \textbf{Inference for a Difference in Proportions:} Design, execute, and interpret confidence intervals and hypothesis tests for a difference in proportions. Choose when to use a paired test and when to use an independent test. [Q4, L5] \textcolor{red}{Core}

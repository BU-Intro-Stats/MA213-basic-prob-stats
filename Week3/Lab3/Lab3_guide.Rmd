...
From `Temp` Create a new column named `Temp_C`. Below is the formula for Celsius.
...
# -------------------------------
df_filtered <- df %>%
  filter(!is.na(x))  # Keep only rows where x is NOT NA
...
You want to study Ozone levels after May. 1. Filter the data to include only the months June through September.
...
2.  Create a boxplot to show the distribution of Ozone levels for these months.
...
3.  Create a histogram to show the distribution of Ozone levels for these months.

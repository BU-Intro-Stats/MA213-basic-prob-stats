...
\pause
\small{
\hl{The Least Squares solutions for $\beta_0$ and $\beta_1$ are the ``maximum likelihood estimators" for the intercept and slope if our three conditions are met.}
}

...
### Lecture 31
- **Topic:** Beyond Recipes: Frequentist and Bayesian Approaches to Statistical Modeling
- **Reading:** (TBD resource on ML estimation)
- **Learning Objectives:**
...
### Lecture 32
- **Topic:** Frequentist modeling using the likelihood function
- **Reading:** Bayes' Rules Chapter 2
- **Learning Objectives:**
  - M5, LO1: The Frequentist Perspective
...
- **Learning Objectives:**
  - M5, LO2: The Bayesian Perspective
  - M5, L04: Bayesian Modeling 1

### Lecture 34
- **Topic:** Bayesian modeling with the beta-binomial model
- **Reading:** (none)
- **Learning Objectives:**
  - M5, LO2: The Bayesian Perspective
  - M5, L05: Bayesian Modeling 2

### Lecture 35
- **Topic:** Case study in modern statistical modeling
- **Reading:** (none)
- **Learning Objectives:**
  - M5, LO1: The Frequentist Perspective
  - M5, LO2: The Bayesian Perspective

...
\begin{enumerate}
    \item Project 2 launch and outline: see the current course calendar.
    \item Deliverable 1: Project Outline, due with the Lab 6 deliverables; see the current course calendar for the time.
    \item Project 2 work sessions and Deliverables 2--3: see the current course calendar.
\end{enumerate}
...
\begin{itemize}
    \item Deliverable 1: Project Outline (due with the Lab 6 deliverables; see the current course calendar)
    \item Deliverable 2: Project Plan (Results slides + R code + Datafile)
    \item Deliverable 3: Writeup + R code (final version + Datafile)
\end{itemize}

...
\begin{frame}
	...
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	You will receive an email with instructions for setting up your computer for R and RStudio. Please complete the setup before your first lab!
\end{frame}
...
\begin{frame}
	...
	\hline
	Labs & $<$3 missed & $<$4 missed & $<$5 missed \\
	\hline
	\end{tabular}
	\end{table}
...
\begin{frame} % TODO check these
	...
	\begin{enumerate}
		...
		\item (Quizzes) Given R code for a statistical analysis, I can explain what it does and why, and identify both programmatic and statistical errors 

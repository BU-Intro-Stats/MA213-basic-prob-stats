...
\include{Lecture29_agenda}
\include{Lecture29_announcements}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Sections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Edfinity Quiz: Variability}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}
\frametitle{Within-group and between-group variability}
\begin{center}
\includegraphics[width=0.8\textwidth]{./Figure 7.19.png}
\end{center}

It is easier to detect differences between group means when the variability within groups is small.
\end{frame}
...
\[ SSE = \sum_{i = 1}^{n} (x_i - \bar{x}_i)^2 \]

But it's easier to calculate as:
\[ SSE = SST - SSG \]
}
...
\section{R Demonstration: ANOVA p-value}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Edfinity Quiz: ANOVA interpretation}

...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../../Module1/lecture01/figures/BigPicture1.png}
    \end{center}
    \vspace{0.5em}
    \footnotesize
...
\begin{frame}
    \frametitle{Big Picture of Statistics}
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../../Module1/lecture01/figures/BigPicture2.png}
    \end{center}
    \vspace{0.5em}
    \footnotesize
    Credit: \href{https://stats.libretexts.org/Bookshelves/Applied_Statistics/Biostatistics_-_Open_Learning_Textbook/Preliminaries/The_Big_Picture}{LibreTexts}

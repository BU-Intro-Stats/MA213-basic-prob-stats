...
\section{Edfinity Quiz: Kid's test scores}
...
\section{Preview: Measuring model fit in multiple regression}
...
\item But if the added variable doesn't really provide any new information, or is completely unrelated, adjusted $R^2$ does not increase. It is an \underline{unbiased} estimate of the proportion of explained variability in $y$ for a new data set.

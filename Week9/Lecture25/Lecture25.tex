...
\begin{frame}
  ...
  Now we're returning to the setting with multiple samples, but we have observations that don't appear independent - like in the next example. 
...
\section{Think/pair/share: How would you set up the hypotheses?}  % Like slides 5-7

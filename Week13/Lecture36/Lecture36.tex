...
\section{Reminder: $R^2$ for Multiple Linear Regression}
...
\section{Edfinity Quiz: Interpreting model output for beauty}
...
\section{Edfinity Quiz: Interpreting model output for beauty 2}
...
\section{Edfinity Quiz: Interpreting model output for beauty 3}
...
\begin{frame}
\frametitle{Think/Pair/Share: Model selection strategies}
...
\section{R demonstration: Model selection for beauty data}

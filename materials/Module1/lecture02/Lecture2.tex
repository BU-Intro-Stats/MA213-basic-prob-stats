...
\include{Lecture2_announcements}
...
\begin{frame}
	\frametitle{Worksheet: Types of Variables}

	On your own, classify each variable below as \textbf{categorical} (regular or ordinal) or \textbf{numerical} (continuous or discrete):

	\begin{itemize}
		\item How many caffeinated drinks (e.g.\ coffee, tea, soda) do you have per day, on average?
		\item What is your class year? Choose the answer from a drop-down menu.
		\item Do you consider yourself introverted or extroverted?
	\end{itemize}
\end{frame}

...
\section{Edfinity Quiz: LA zip codes}
...
\dq{Is there a statistically significant relationship between \% Hispanic and \% college graduates in zip code areas in LA?}
...
\dq{Are the zip code areas independent?}
\vspace{-0.5em}
\soln{\only<4->{Probably not, since zip code areas that are close to each other may have similar characteristics beyond race (so the residuals are likely not independent).
}}

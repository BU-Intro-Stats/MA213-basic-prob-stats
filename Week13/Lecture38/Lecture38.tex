...
\begin{itemize}
    ...
    \item \textbf{Neuromatch Academy}: \webLink{https://neuromatch.io/}{https://neuromatch.io/} - Online courses and resources on computational neuroscience and machine learning.
    \item \textbf{Articles}:
    \begin{itemize}

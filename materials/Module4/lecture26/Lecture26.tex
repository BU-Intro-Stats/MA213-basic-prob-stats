...
\include{Lecture26_announcements}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Sections
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\Note{In order to get a 90\% CI, we need to find the critical value that leaves 5\% in each tail. So we use 0.95 in the \texttt{qt()} function.}
